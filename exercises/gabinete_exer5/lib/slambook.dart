...
import 'package:gabinete_exer5/info_page.dart';
import 'main.dart';
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          ...
          if (doneValues["nameOnChanged"] != "") {
            ...
            // add to friends list (if it's still not there, else just edit the info)
            bool nameExists = false;
            int indexToReplace = 0;
            for (int i = 0; i < Friends.friendsList.length; i++) {
              if (Friends.friendsList[i].name == friendInfo.name) {
                nameExists = true;
                indexToReplace = i;
                break;
              }
            ...
            if (nameExists == false) {
              Friends.friendsList.add(friendInfo);
            } else {
              Friends.friendsList[indexToReplace] = friendInfo;
            }
            // change page
            Navigator.pushNamed(
              context,
